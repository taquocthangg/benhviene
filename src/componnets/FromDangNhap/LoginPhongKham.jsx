...
const LoginPhongKham = () => {
  ...
  return (
    ...
    <div className="name"> <img src="https://clinic.medpro.vn/javax.faces.resource/medpro-logo.svg.xhtml?ln=images" alt="" /></div>
    <form className="from__dangnhap" onSubmit={handleSubmit(onSubmit)}>
      ...
      <button className='dangnhap' type="submit">Đăng Nhập</button>
